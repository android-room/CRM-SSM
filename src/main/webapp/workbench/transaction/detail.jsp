...
<%@ page import="com.settings.domain.DicValue" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.workbench.domain.Tran" %>
...
<script type="text/javascript">
	...
	function changeIcon(stage,index1) {
		...
		console.log("当前阶段可能性"+currentPossibility)
		console.log("当前阶段的下标"+index)
		console.log("前面正常阶段和后面丢失阶段的分界点下标"+point)
		console.log("============")
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<%
			...
			String currentStage = t.getStage(); //成交
			String currentPossibility = pMap.get(currentStage); // 100
		...
		%>
		<span id="<%=i%>" onclick="changeStage('<%=listStage%>','<%=i%>')" class="glyphicon glyphicon-record mystage" data-toggle="popover" data-placement="bottom" data-content="<%=dv.getText()%>" style="color: #90F790;"></span>-----------
		<%
						}else {
							//黑圈
		%>
...
<%--		<span class="closingDate">2010-10-10</span>--%>
	...
	<div style="position: relative; top: 0px;">
		<div style="position: relative; left: 40px; height: 30px;">
			<div style="width: 300px; color: gray;">所有者?<%=point%></div>
		...
		<div style="position: relative; left: 40px; height: 30px; top: 40px;">
			...
			<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b>123456</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
