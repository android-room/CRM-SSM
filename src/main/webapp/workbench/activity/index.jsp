...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#searchBtn").click(function () {
			...
			console.log($("#hidden-name").val());
			console.log($("#hidden-owner").val());
			console.log($("#hidden-startDate").val());
			console.log($("#hidden-endDate").val());
			...
			$.ajax({
				...
				success:function (data) {
					if (data){
						//pageList(1,2);
                            var $xz = $("input[name=xz]:checked");
                            console.log($xz.parent().parent().remove());
					}else {
						alert("失败")
					}
				}
