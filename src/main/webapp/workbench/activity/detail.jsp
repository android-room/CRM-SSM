...
<script type="text/javascript">
	...
	$(function(){
                ...
                success:function (data) {
                   if(this.success){
                       ...
                       var html = "";
                           ...
                           html += '<font color="gray">市场活动</font> <font color="gray">-</font> <b>${data.ar.name}</b> <small style="color: gray;" id="s'+data.ar.id+'"> '+(data.ar.editFlag==0?data.ar.createTime:data.ar.editTime)+' 由'+(data.ar.editFlag==0?data.ar.createBy:data.ar.editBy)+'</small>';
        ...
        $("#updateRemarkBtn").click(function () {
            ...
            var id = $("#remarkId").val();
            $.ajax({
                url:"workbench/activity/updateRemarkBtn.do",
                data:{
                    "id":id,
                ...
                success:function (data) {
                    if (data.success){
                        //修改成功
                        //更新div中相应的信息，需要更新内容有，noteContent，editTime,editBy
